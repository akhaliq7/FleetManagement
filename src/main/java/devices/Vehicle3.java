...
public class Vehicle3 implements Runnable
{
    ...
    public Vehicle3() throws Exception {
        DeviceConfig config;
        DeviceConfigIdentity identity = new DeviceConfigIdentity("sra4nc", "vehicles", "vehicle_3");
        DeviceConfigAuth auth = new DeviceConfigAuth("IBhtR?mvi4ko(5!oEy");
    ...
    public JsonArray createData() throws IOException {
        String in = "src/main/java/json/vehicle3.json";
        ...
        for(int i = 0; i < v.length; i++)
        {
            ...
            d.addProperty("id", 3);
            d.addProperty("name", "David Potter");
            d.addProperty("registration_number", "sp20bru");
